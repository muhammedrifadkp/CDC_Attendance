...
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/cadd_attendance
...
VITE_PROD_API_URL=https://your-backend-url.com/api
...
<details>
<summary><b>🚀 Step 4: Start Development</b></summary>
...
|------|-------------|--------|
| 🏢 **Initial Setup** | Configure departments, courses, and teacher accounts | Admin Dashboard |
| 👥 **User Management** | Add/edit teachers and students with role assignments | User Management |
| 📊 **System Monitoring** | View analytics, generate reports, and track KPIs | Analytics Panel |
| 🖥️ **Lab Configuration** | Set up PC layout, booking rules, and maintenance | Lab Management |
| 🔐 **Security Settings** | Manage permissions, authentication, and system security | Settings |
...
<details>
<summary><b>📚 Teaching Operations</b></summary>

| Task | Description | Features |
|------|-------------|----------|
| ✅ **Daily Attendance** | Mark student attendance for assigned batches | Bulk marking, late entries |
| 👨‍🎓 **Student Management** | View and manage student information | Profiles, batch assignments |
| 🖥️ **Lab Booking** | Reserve lab slots for practical sessions | Real-time availability |
| 📊 **Reports** | Generate attendance reports and analytics | Export to Excel/PDF |
| 📧 **Notifications** | Receive and manage system notifications | Email integration |

**Teacher Login:**
- Use Employee ID or Email
- Example: `CADD-001` or `teacher@cdc.com`
</details>

### 🔬 **For Lab Management**

<details>
<summary><b>🖥️ Lab Operations</b></summary>

| Feature | Description | Benefits |
|---------|-------------|----------|
| 🎯 **PC Status** | Monitor real-time PC availability and status | Visual indicators |
| 📅 **Booking Management** | Handle lab slot reservations and scheduling | Conflict prevention |
| 🔧 **Maintenance** | Track PC maintenance and technical issues | Downtime tracking |
| 📊 **Utilization** | Monitor lab usage and resource optimization | Efficiency reports |
...
| `PUT` | `/api/users/reset-password-with-otp` | Reset password with OTP | ❌ |
...
| Method | Endpoint | Description | Auth Required |
|--------|----------|-------------|---------------|
| `GET` | `/api/lab/pcs` | Get all PC information | ✅ |
| `POST` | `/api/lab/pcs` | Create new PC entry | ✅ |
| `GET` | `/api/lab/bookings` | Get all bookings | ✅ |
| `POST` | `/api/lab/bookings` | Create new booking | ✅ |
| `GET` | `/api/lab/availability/:date` | Check availability for date | ✅ |
