...
const AdminBatchAttendanceDetails = () => {
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <button
            onClick={() => navigate(`/admin/attendance/mark/${batchId}`)}
          ...
          <button
            onClick={() => navigate(`/admin/batches/${batchId}/attendance/report`)}
            className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cadd-red transition-all duration-300 shadow-md"
          >
...
export default AdminBatchAttendanceDetails
