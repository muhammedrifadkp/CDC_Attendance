...
const SimpleAdminProjectEdit = () => {
  ...
  const hasSubmissions = (project.submissionCount || 0) > 0
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 px-4 sm:px-0">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Edit Project (Admin)</h1>
      ...
      {/* Warning for projects with submissions */}
      {hasSubmissions && (
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-yellow-700">
                This project has {project.submissionCount} submission(s). Be careful when modifying deadlines or requirements.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <span className="text-blue-700 font-medium">Assigned By:</span>
            <span className="ml-2 text-blue-900">{project.assignedBy?.name}</span>
          </div>
          <div>
                ...
                <span className="ml-2">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    ...
                    {formData.status === 'completed' ? 'Completed' : 
                     formData.status === 'in_progress' ? 'In Progress' : 'Assigned'}
                  </span>
                </span>
              </div>
              <div>
...
export default SimpleAdminProjectEdit
