  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <BackButton />
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Send Notification to Teachers</h1>
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          {/* Basic Information */}
          <div className="space-y-6">
            <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Message Content</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-gray-500 text-sm mt-1">{formData.message.length}/2000 characters</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {formData.targetAudience === 'department' && (
              <div>
                ...
                {errors.targetDepartment && <p className="text-red-500 text-sm mt-1">{errors.targetDepartment}</p>}
              </div>
            )}
                  ...
                  {teachers.map(teacher => (
                    <label key={teacher._id} className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        {teacher.department && (
                          <span className="text-xs text-gray-400 ml-2">- {teacher.department.name}</span>
                        )}
                      </div>
                    </label>
                  ))}
                </div>
                {errors.targetTeachers && <p className="text-red-500 text-sm mt-1">{errors.targetTeachers}</p>}
          ...
          {/* Email Options */}
          <div className="space-y-6">
            <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Delivery Options</h3>
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-cadd-red focus:ring-cadd-red border-gray-300 rounded"
              />
              <label htmlFor="sendEmail" className="ml-3 flex items-center">
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-gradient-to-r from-cadd-red to-cadd-pink text-white rounded-lg hover:from-cadd-pink hover:to-cadd-red transition-all duration-300 disabled:opacity-50 flex items-center space-x-2"
            >
              {loading ? (
